...
from backend.ai_service.main import app # Corrected import
from backend.ai_service.document_pipeline import extract_text_from_pdf, extract_text_from_docx, chunk_text # Corrected import
...
@patch('backend.ai_service.document_pipeline.process_document') # Corrected patch path
@patch('backend.ai_service.ai_client.generate_summary') # Corrected patch path
@patch('backend.ai_service.ai_client.generate_flashcards') # Corrected patch path
@patch('backend.ai_service.ai_client.generate_quiz') # Corrected patch path
def test_upload_document_pdf_success(mock_generate_quiz, mock_generate_flashcards, mock_generate_summary, mock_process_document):
    ...
    with open("backend/ai_service/tests/sample.pdf", "rb") as f: # Updated path
